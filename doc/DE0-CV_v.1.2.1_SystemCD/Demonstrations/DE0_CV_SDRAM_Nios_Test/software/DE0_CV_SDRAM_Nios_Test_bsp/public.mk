...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../DE0_CV_SDRAM_Nios_Test.jdi
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x20041048
SOPC_SYSID_FLAG += --sidp=0x20041048
ELF_PATCH_FLAG  += --sidp 0x20041048

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1416191880
SOPC_SYSID_FLAG += --timestamp=1416191880
ELF_PATCH_FLAG  += --timestamp 1416191880
