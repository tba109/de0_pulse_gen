...
// 
// Generated using ACDS version 14.0 209 at 2014.11.17.10:38:29
...
module DE0_CV_QSYS_mm_interconnect_0 (
		...
		input  wire [29:0] nios2_qsys_data_master_address,                    //                      nios2_qsys_data_master.address
		...
		input  wire [29:0] nios2_qsys_instruction_master_address,             //               nios2_qsys_instruction_master.address
	...
	wire   [29:0] nios2_qsys_instruction_master_translator_avalon_universal_master_0_address;       // nios2_qsys_instruction_master_translator:uav_address -> nios2_qsys_instruction_master_agent:av_address
	...
	wire   [29:0] nios2_qsys_data_master_translator_avalon_universal_master_0_address;              // nios2_qsys_data_master_translator:uav_address -> nios2_qsys_data_master_agent:av_address
	...
	wire   [29:0] nios2_qsys_jtag_debug_module_agent_m0_address;                                    // nios2_qsys_jtag_debug_module_agent:m0_address -> nios2_qsys_jtag_debug_module_translator:uav_address
	...
	wire  [106:0] nios2_qsys_jtag_debug_module_agent_rf_source_data;                                // nios2_qsys_jtag_debug_module_agent:rf_source_data -> nios2_qsys_jtag_debug_module_agent_rsp_fifo:in_data
	...
	wire  [106:0] nios2_qsys_jtag_debug_module_agent_rsp_fifo_out_data;                             // nios2_qsys_jtag_debug_module_agent_rsp_fifo:out_data -> nios2_qsys_jtag_debug_module_agent:rf_sink_data
	...
	wire  [105:0] cmd_mux_src_data;                                                                 // cmd_mux:src_data -> nios2_qsys_jtag_debug_module_agent:cp_data
	wire    [6:0] cmd_mux_src_channel;                                                              // cmd_mux:src_channel -> nios2_qsys_jtag_debug_module_agent:cp_channel
	...
	wire   [29:0] onchip_memory2_s1_agent_m0_address;                                               // onchip_memory2_s1_agent:m0_address -> onchip_memory2_s1_translator:uav_address
	...
	wire  [105:0] cmd_mux_001_src_data;                                                             // cmd_mux_001:src_data -> onchip_memory2_s1_agent:cp_data
	wire    [6:0] cmd_mux_001_src_channel;                                                          // cmd_mux_001:src_channel -> onchip_memory2_s1_agent:cp_channel
	...
	wire    [6:0] cmd_mux_002_src_channel;                                                          // cmd_mux_002:src_channel -> sysid_qsys_control_slave_agent:cp_channel
	...
	wire  [105:0] cmd_mux_003_src_data;                                                             // cmd_mux_003:src_data -> timer_s1_agent:cp_data
	wire    [6:0] cmd_mux_003_src_channel;                                                          // cmd_mux_003:src_channel -> timer_s1_agent:cp_channel
	...
	wire   [29:0] jtag_uart_avalon_jtag_slave_agent_m0_address;                                     // jtag_uart_avalon_jtag_slave_agent:m0_address -> jtag_uart_avalon_jtag_slave_translator:uav_address
	...
	wire  [105:0] cmd_mux_004_src_data;                                                             // cmd_mux_004:src_data -> jtag_uart_avalon_jtag_slave_agent:cp_data
	...
	wire    [6:0] cmd_mux_005_src_channel;                                                          // cmd_mux_005:src_channel -> key_s1_agent:cp_channel
	...
	wire  [105:0] nios2_qsys_instruction_master_agent_cp_data;                                      // nios2_qsys_instruction_master_agent:cp_data -> router:sink_data
	...
	wire  [105:0] nios2_qsys_data_master_agent_cp_data;                                             // nios2_qsys_data_master_agent:cp_data -> router_001:sink_data
	...
	wire  [105:0] nios2_qsys_jtag_debug_module_agent_rp_data;                                       // nios2_qsys_jtag_debug_module_agent:rp_data -> router_002:sink_data
	...
	wire  [105:0] onchip_memory2_s1_agent_rp_data;                                                  // onchip_memory2_s1_agent:rp_data -> router_003:sink_data
	...
	wire  [105:0] timer_s1_agent_rp_data;                                                           // timer_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [105:0] jtag_uart_avalon_jtag_slave_agent_rp_data;                                        // jtag_uart_avalon_jtag_slave_agent:rp_data -> router_006:sink_data
	...
	wire  [105:0] router_src_data;                                                                  // router:src_data -> nios2_qsys_instruction_master_limiter:cmd_sink_data
	wire    [6:0] router_src_channel;                                                               // router:src_channel -> nios2_qsys_instruction_master_limiter:cmd_sink_channel
	...
	wire  [105:0] nios2_qsys_instruction_master_limiter_cmd_src_data;                               // nios2_qsys_instruction_master_limiter:cmd_src_data -> cmd_demux:sink_data
	wire    [6:0] nios2_qsys_instruction_master_limiter_cmd_src_channel;                            // nios2_qsys_instruction_master_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire  [105:0] rsp_mux_src_data;                                                                 // rsp_mux:src_data -> nios2_qsys_instruction_master_limiter:rsp_sink_data
	wire    [6:0] rsp_mux_src_channel;                                                              // rsp_mux:src_channel -> nios2_qsys_instruction_master_limiter:rsp_sink_channel
	...
	wire    [6:0] nios2_qsys_instruction_master_limiter_rsp_src_channel;                            // nios2_qsys_instruction_master_limiter:rsp_src_channel -> nios2_qsys_instruction_master_agent:rp_channel
	...
	wire  [105:0] router_001_src_data;                                                              // router_001:src_data -> nios2_qsys_data_master_limiter:cmd_sink_data
	wire    [6:0] router_001_src_channel;                                                           // router_001:src_channel -> nios2_qsys_data_master_limiter:cmd_sink_channel
	...
	wire  [105:0] nios2_qsys_data_master_limiter_cmd_src_data;                                      // nios2_qsys_data_master_limiter:cmd_src_data -> cmd_demux_001:sink_data
	wire    [6:0] nios2_qsys_data_master_limiter_cmd_src_channel;                                   // nios2_qsys_data_master_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	...
	wire  [105:0] rsp_mux_001_src_data;                                                             // rsp_mux_001:src_data -> nios2_qsys_data_master_limiter:rsp_sink_data
	wire    [6:0] rsp_mux_001_src_channel;                                                          // rsp_mux_001:src_channel -> nios2_qsys_data_master_limiter:rsp_sink_channel
	...
	wire    [6:0] nios2_qsys_data_master_limiter_rsp_src_channel;                                   // nios2_qsys_data_master_limiter:rsp_src_channel -> nios2_qsys_data_master_agent:rp_channel
	...
	wire    [6:0] nios2_qsys_instruction_master_limiter_cmd_valid_data;                             // nios2_qsys_instruction_master_limiter:cmd_src_valid -> cmd_demux:sink_valid
	wire    [6:0] nios2_qsys_data_master_limiter_cmd_valid_data;                                    // nios2_qsys_data_master_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
	...
	altera_merlin_slave_agent #(
		...
		.rdata_fifo_sink_ready   (timer_s1_agent_rdata_fifo_src_ready),               // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (timer_s1_agent_rdata_fifo_src_valid),               //                .valid
		.rdata_fifo_sink_data    (timer_s1_agent_rdata_fifo_src_data),                //                .data
	...
	DE0_CV_QSYS_mm_interconnect_0_router_004 router_006 (
	...
	DE0_CV_QSYS_mm_interconnect_0_router_004 router_007 (
	...
	DE0_CV_QSYS_mm_interconnect_0_cmd_mux_002 cmd_mux_005 (
		.clk                 (pll_outclk0_clk),                                   //       clk.clk
		.reset               (onchip_memory2_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE0_CV_QSYS_mm_interconnect_0_cmd_mux_002 cmd_mux_006 (
		.clk                 (pll_outclk0_clk),                                   //       clk.clk
		.reset               (onchip_memory2_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE0_CV_QSYS_mm_interconnect_0_rsp_demux_002 rsp_demux_005 (
		.clk                (pll_outclk0_clk),                                   //       clk.clk
		.reset              (onchip_memory2_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE0_CV_QSYS_mm_interconnect_0_rsp_demux_002 rsp_demux_006 (
		.clk                (pll_outclk0_clk),                                   //       clk.clk
		.reset              (onchip_memory2_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
